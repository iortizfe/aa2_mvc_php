			...
			<div class="grid-row">
				...
				<div class="grid-md-6">
					<div class="form-group pd-10">
						...
						<input id="login_nif" name="nif" type="text"  placeholder="nif" value="<?php if(isset($_POST['nif'])){echo $_POST['nif'];} else { echo $user->nif; } ?>" required>
			...
			<div class="grid-row">
				...
				<div class="grid-md-6">
					<div class="form-group pd-10">
						...
						<input id="login_name" name="surname" type="text"  placeholder="Apellido"  value="<?php if(isset($_POST['surname'])){echo $_POST['surname'];} else { echo $user->surname; }?>" required>
			...
			<div class="grid-row">
				...
				<div class="grid-md-6">
					<div class="form-group pd-10">
						...
						<input id="login_telephone" name="telephone" type="phone"  placeholder="Telefono"  value="<?php if(isset($_POST['telephone'])){echo $_POST['telephone'];} else { echo $user->telephone; } ?>" required>
