  ...
  <div class="swiper-container o-swiper-home">
    <div class="swiper-wrapper">     
      <div class="swiper-slide">
        <img class="a-object-cover" src="./assets/img/slider/slider5.jpg" />
      </div>
      <div class="swiper-slide">
        <img class="a-object-cover" src="./assets/img/slider/slider2.jpg" />
      </div>
      <div class="swiper-slide">
        <img class="a-object-cover" src="./assets/img/slider/slider3.jpg" />
      </div>
      <div class="swiper-slide">
        <img class="a-object-cover" src="./assets/img/slider/slider4.jpg" />
      </div>
...
<section class="quehay-section">
    <h1>¿Que es <img src="./assets/img/logo.svg" />?</h1>
    <div class="o-featured-module">
        <article class="m-featured-item">
            <div class="icon">
                <img class="a-object-cover" src="./assets/img/icons/aprender.svg" />
            </div>
            <h5>Agrega tus clases</h5>
        </article>
        <article class="m-featured-item">
            <div class="icon">
                <img class="a-object-cover" src="./assets/img/icons/leccion-en-linea.svg" />
            </div>
            <h5>Permite que se apunten</h5>
        </article>
        <article class="m-featured-item">
            <div class="icon">
                <img class="a-object-cover" src="./assets/img/icons/crecimiento.svg" />
            </div>
...
<section class="utilidad-section">
    <div class="p6-wrap">
        <div class="image">
            <img class="a-object-cover" src="./assets/img/home/estudiante1.jpg" />
        </div>
        <div class="content">
            <h2>¿Como funciona?</h2>
